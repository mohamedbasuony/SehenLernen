...
async def similarity_search(request: SimilaritySearchRequest, session_id: Optional[str] = Query(None)):
    """
...
async def angle_comparison(request: AngleComparisonRequest, session_id: Optional[str] = Query(None)):
    """
